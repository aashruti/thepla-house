...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "At Thepla House by Tejal's Kitchen we serve full Jain thalis (no onion, garlic or root vegetables) and vegan thalis (dairy swapped for oil). So whether you eat satvik, plant-based or everything, the home-style Gujarati thali is built for you." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "We cook full Jain menus every day — Jain thalis, Jain farsan and Jain sweets — all 100% vegetarian, whole wheat and free of palm oil and preservatives. Just ask when you order, and our kitchens also handle full Jain catering for poojas, festivals and functions across Mumbai." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "ul", items: ["100% whole-wheat methi, plain, garlic and palak theplas", "Full Gujarati thalis, mini thalis, and Jain & vegan thalis", "Farsan — dhokla, khandvi, patra, handvo, sabudana khichdi", "Sweets — mohanthal, sukhdi, basundi, shrikhand", "Jain and vegan options available"] },
