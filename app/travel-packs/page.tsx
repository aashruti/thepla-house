...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Vacuum-packed methi thepla travel packs — 100% whole wheat, no preservatives, fresh for 7+ days. Made to carry on any journey. Buy at any Thepla House by Tejal's Kitchen outlet in Mumbai.",
  path: "/travel-packs",
});
...
const FAQS = [
  ...
  },
  {
    ...
    a: "We don't ship — travel packs are made to carry. Buy them at any Thepla House by Tejal's Kitchen outlet (or order on WhatsApp for pickup) and take them with you. Vacuum-sealed, they stay fresh 7+ days, so customers regularly carry them across India and abroad.",
  },
  {
